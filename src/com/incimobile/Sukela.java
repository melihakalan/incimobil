...
public class Sukela extends ActionBarActivity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.activity_sukela);
		
		Global = this.getApplication();
		getSupportActionBar().setDisplayHomeAsUpEnabled(true);
		
		bodyContainer = (LinearLayout) findViewById(R.id.sukela_body);
		tTopic = (TextView) findViewById(R.id.sukela_topic);
	...
	{
		getMenuInflater().inflate(R.menu.sukela, menu);
		return true;
	}
	...
	private void loadSukela()
	{
		...
		final String fulladr = "http://inci.sozlukspot.com/ss_entry.php?ne=su";
				...
				try
				{
					...
					else
					{
						...
						sHandler.post(new Runnable()
						{
							...
							public void run()
							{
								((App)Global).ShowDialog(Sukela.this, "Hata", "entry'ler alinamadi");
							}
						});
					}
	...
	private void getSukela(String response)
	{
		int si = 0, ei;
		...
		Log.d("sukela topic", sTopicLink);
		
		TextView tEntry = new TextView(Sukela.this);
		...
		LinearLayout infos = new LinearLayout(Sukela.this);
		...
		TextView tNick = new TextView(Sukela.this);
		...
		tNick.setOnLongClickListener(new OnLongClickListener()
		{
			...
			public boolean onLongClick(View v)
			{
				...
				Intent intent = new Intent(Sukela.this, User.class);
				intent.putExtras(b);
		...
		TextView tDate = new TextView(Sukela.this);
		...
		LinearLayout idlayout = new LinearLayout(Sukela.this);
		...
		TextView tNum = new TextView(Sukela.this);
		...
		{
			TextView tRate = new TextView(Sukela.this);
			...
			TextView tMsg = new TextView(Sukela.this);
			...
			tMsg.setOnClickListener(new OnClickListener()
			{
				...
				public void onClick(View v)
				{
					Intent intent_msg = new Intent(Sukela.this, Msg.class);
					Bundle b = new Bundle();
			...
			{
				TextView tEdit = new TextView(Sukela.this);
				...
				tEdit.setOnClickListener(new OnClickListener()
				{
					...
					public void onClick(View v)
					{
						Intent intent_edit = new Intent(Sukela.this, Edit.class);
						Bundle b = new Bundle();
				...
				TextView tDelete = new TextView(Sukela.this);
				...
				tDelete.setOnClickListener(new OnClickListener()
				{
					...
					public void onClick(View v)
					{
						AlertDialog.Builder dlgAlert  = new AlertDialog.Builder(Sukela.this);                      
				...
				try
				{
					...
					else
					{
						...
						sHandler.post(new Runnable()
						{
							...
							public void run()
							{
								((App)Global).ShowDialog(Sukela.this, "Hata", "entry silinemedi.");
							}
						});
					}
				}catch(Exception e){e.printStackTrace();}
				...
				try
				{
					...
					else
					{
						...
						sHandler.post(new Runnable()
						{
							...
							public void run()
							{
								((App)Global).ShowDialog(Sukela.this, "Hata", "oy verilemedi.");
							}
						});
					}
				}catch(Exception e){e.printStackTrace();}
	...
	private void goUserTopic(String nick)
	{
		...
		Intent intent = new Intent(Sukela.this, Topic.class);
		Bundle b = new Bundle();
